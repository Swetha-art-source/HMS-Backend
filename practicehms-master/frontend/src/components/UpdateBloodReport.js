...
export default function UpdateBloodReport() {
    ...
    useEffect(() => {
        function getBloodReports() {
            axios.get("http://localhost:8050/bloodreport/getBloodReport/" + id).then((res) => {
    ...
    function handle(e) {
        ...
        axios.put("http://localhost:8050/bloodreport/updateBloodReport/" + id, UpdateBloodReport).then(function () {
