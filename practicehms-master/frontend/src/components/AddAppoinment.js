...
export default function AddAppoinment() {
    ...
    function btnClick(e) {
        ...
        if (validate === true) {
            ...
            axios.post("http://localhost:8050/appoinment/addAppointment", formData).then(function () {
    ...
    useEffect(function () {
        ...
        function getAppoinment() {
            axios.get("http://localhost:8050/doctor/readDoctors").then(function (res) {
        ...
        function getAppoinmentDetails() {
            axios.get("http://localhost:8050/appoinment/readAppointments").then(function (res) {
