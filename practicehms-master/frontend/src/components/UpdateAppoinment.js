...
export default function UpdateAppoinment() {
    ...
    useEffect(function () {
        ...
        function getAppoinment() {
            axios.get("http://localhost:8050/appoinment/getOneAppointment/" + id).then((res) => {
    ...
    function btnClick(e) {
        ...
        axios.put("http://localhost:8050/appoinment/updateAppointment/" + id, updatedAppointment).then(function () {
