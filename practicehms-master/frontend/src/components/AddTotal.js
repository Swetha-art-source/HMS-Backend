...
export default function AddTotal() {
    ...
    function btnClick(e) {
        e.preventDefault();
        console.log("btnClick function called");
        ...
        axios.post("http://localhost:8050/upd/add", formData).then(function () {
            ...
            console.log("End of btnClick function");
    ...
    function cancel(e) {
        e.preventDefault();
        navigate("/addNewMedicine"); // navigate to medicine page after successful addition of medicine
